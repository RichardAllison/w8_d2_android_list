...
public class TopDestinations {
    ...
    public TopDestinations() {
        ...
        topDestinations.add(new Destination(4,"Dublin","Ireland"));
        topDestinations.add(new Destination(5,"Tokyo","Japan"));
        topDestinations.add(new Destination(6,"Isle of Skye","Scotland"));
        ...
        topDestinations.add(new Destination(14,"Edinburgh","Scotland"));
        topDestinations.add(new Destination(15,"Yellowstone National Park","USA"));
        topDestinations.add(new Destination(16,"Havana","Cuba"));
        topDestinations.add(new Destination(17,"San Juan","Puerto Rico"));
        topDestinations.add(new Destination(18,"Hamburg","Germany"));
        topDestinations.add(new Destination(19,"Nile","Egypt"));
